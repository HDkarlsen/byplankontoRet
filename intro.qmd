...
Denne dokumentasjonen blei til i mars 2023. Koden forventes å kunne kjøres uten problemer en stund framover. Som jeg nevner i *Versjonering* vil kanskje framtidige versjoner av R og `tidyverse` gjøre endringer som påvirker koden min her. Om dere får tak i samme versjon av R og `tidyverse` vil dere unngå eventuelle problemer forbundet med dette. 
