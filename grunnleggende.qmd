...
Men før det, noen kjappe digresjoner
...
<!-- fortsett her 
-x hente ut elementer med [] og [[]].
-x lister av lister
-x data frames og tibbles.
- environment
-x $ operator
-x named lists og etc.
-x vise en rekke av elementer
-x hvorfor bruker vi her noen ganger = istedenfor <-?
- funksjoner
-->
